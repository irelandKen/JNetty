...
public class ErrorRequest extends ForwardRequest
{
	...
	public ErrorRequest(HttpServletRequest request, HttpServletResponse response, HttpInvocation invocation)
	{
	...
	static
	{
		_errorAttributeMap.put(RequestDispatcher.ERROR_REQUEST_URI, REQUEST_URI_CODE);
	}
}
